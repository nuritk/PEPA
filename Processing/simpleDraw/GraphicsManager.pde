...
class GraphicsManager{
  ...
  void drawCircle(int x, int y, int r, color c) {
    // normally would have a clear here
    
    parent.sendMessage("<C,"+str(x)+","+str(y)+", "+str(r)+","+red(c)+","+green(c)+","+blue(c)+">");
    //println("<C,"+str(x)+","+str(y)+", "+str(r)+","+red(c)+","+green(c)+","+blue(c)+">");
  }
}
...
class CText extends CGraphicsObject {
  ...
  String createDrawMessage() {
    //return "<T,"+str(cx)+","+str(cy)+","+str(h)+","+str+">";
